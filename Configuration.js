...
function getEndpoints(deviceAddress, endpoints) {
    ...
    endpoints.addEndpoint("2", "Status 1", endpointType.iasSensor, iasEndpointSubType.alarmInput);
    endpoints.addEndpoint("3", "Status 2", endpointType.iasSensor, iasEndpointSubType.alarmInput);
  }
